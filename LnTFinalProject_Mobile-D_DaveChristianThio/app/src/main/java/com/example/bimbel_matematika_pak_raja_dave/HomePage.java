package com.example.bimbel_matematika_pak_raja_dave;
...
public class HomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseDatabase = FirebaseDatabase.getInstance("https://dave-bimbel-matematika-default-rtdb.firebaseio.com/");
